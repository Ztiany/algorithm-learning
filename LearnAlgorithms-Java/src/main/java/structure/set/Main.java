...
public class Main {
    ...
    public static void main(String... args) {
        ...
        printWords("data/a-tale-of-two-cities.txt", "双城记", new BSTSet<>());
        printWords("data/pride-and-prejudice.txt", "傲慢与偏见", new BSTSet<>());
        System.out.println("linked---------------------------------------------------------------");
        printWords("data/a-tale-of-two-cities.txt", "双城记", new LinkedListSet<>());
        printWords("data/pride-and-prejudice.txt", "傲慢与偏见", new LinkedListSet<>());
    }
